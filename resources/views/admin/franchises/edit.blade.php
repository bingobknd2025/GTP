                    ...
                    <div class="card-body">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" value="{{ $franchise->name }}">
                                </div>

                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    <label for="address" class="form-label">Address:</label>
                                    <textarea class="form-control" id="address" name="address" rows="3">{{ $franchise->address }}</textarea>
                                </div>

                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    <label for="pincode" class="form-label">Pincode:</label>
                                    <input type="text" class="form-control" id="pincode" name="pincode" value="{{ $franchise->pincode }}">
                                </div>

                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    <label for="contact_no" class="form-label">Contact No.:</label>
                                    <input type="text" class="form-control" id="contact_no" name="contact_no" value="{{ $franchise->contact_no }}">
                                </div>
                                ...
                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input type="text" class="form-control" id="contact_person_name" name="contact_person_name" value="{{ $franchise->contact_person_name }}">
                                </div>

                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    <label for="contact_person_number" class="form-label">Contact Person Number:</label>
                                    <input type="text" class="form-control" id="contact_person_number" name="contact_person_number" value="{{ $franchise->contact_person_number }}">
                                </div>

                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    <label for="store_lat" class="form-label">Store Latitude:</label>
                                    <input type="text" class="form-control" id="store_lat" name="store_lat" value="{{ $franchise->store_lat }}">
                                </div>

                                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12">
                                    <label for="store_long" class="form-label">Store Longitude:</label>
                                    <input type="text" class="form-control" id="store_long" name="store_long" value="{{ $franchise->store_long }}">
                                </div>
