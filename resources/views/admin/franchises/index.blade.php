         ...
         columns: [{
            ...
            },
            {
               ...
               render: function(data, type, row) {
                  ...
                  if (data === 'Approved') statusClass = 'btn-success';
                  else if (data === 'Pending') statusClass = 'btn-warning';
                  else if (data === 'Reject') statusClass = 'btn-danger';
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownStatus${row.id}">
                        <li><a class="dropdown-item status-toggle" href="#" data-id="${row.id}" data-status="Pending">Pending</a></li>
                        <li><a class="dropdown-item status-toggle" href="#" data-id="${row.id}" data-status="Approved">Approved</a></li>
                        <li><a class="dropdown-item status-toggle" href="#" data-id="${row.id}" data-status="Reject">Reject</a></li>
                    </ul>
                </div>
            `;
               }
