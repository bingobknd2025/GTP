...
function switcherClick() {
    ...
    let colorMenuVar = colorMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("SparicMenu", 'color');
    });
    /* Color Menu End */
    ...
    let gradientMenuVar = gradientMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("SparicMenu", 'gradient');
    });
    /* Gradient Menu End */
    ...
    let transparentMenuVar = transparentMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("SparicMenu", 'transparent');
    });
    ...
    let colorHeaderVar = colorHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("SparicHeader", 'color');
    });
    /* Color Header End */
    ...
    let gradientHeaderVar = gradientHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("SparicHeader", 'gradient');
    });
    /* Gradient Header End */
    ...
    let transparentHeaderVar = transparentHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("SparicHeader", 'transparent');
    });
    ...
    let fullwidthVar = fullwidthBtn.addEventListener('click', () => {
        ...
        localStorage.removeItem("Sparicboxed");
    });
    ...
    //     localStorage.setItem("Sparicboxed", true);
    ...
    let shadowVar = regular.addEventListener('click', () => {
        ...
        localStorage.setItem("Sparicregular", true);
        localStorage.removeItem("Sparicclassic");
        localStorage.removeItem("Sparicmodern");
    });
    ...
    let noShadowVar = classic.addEventListener('click', () => {
        ...
        localStorage.setItem("Sparicclassic", true);
        localStorage.removeItem("Sparicregular");
        localStorage.removeItem("Sparicmodern");
    });
    ...
    let modernVar = modern.addEventListener('click', () => {
        ...
        localStorage.setItem("Sparicmodern", true);
        localStorage.removeItem("Sparicregular");
        localStorage.removeItem("Sparicclassic");
    });
    ...
    let fixedHeaderVar = fixedHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Sparicheaderfixed", true);
        localStorage.removeItem("Sparicheaderscrollable");
    });

    let scrollHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-position', 'scrollable');
        localStorage.setItem("Sparicheaderscrollable", true);
        localStorage.removeItem("Sparicheaderfixed");
    });
    ...
    let fixedMenuVar = fixedMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("Sparicmenufixed", true);
        localStorage.removeItem("Sparicmenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn.addEventListener('click', () => {
        html.setAttribute('data-menu-position', 'scrollable');
        localStorage.setItem("Sparicmenuscrollable", true);
        localStorage.removeItem("Sparicmenufixed");
    });
    ...
    let closedVar = closedBtn.addEventListener('click', () => {
        closedSidemenuFn();
        localStorage.setItem("Sparicverticalstyles", 'closed');
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
                ele.querySelector('ul').style.display = 'none'
    ...
    let detachedVar = detachedBtn.addEventListener('click', () => {
        detachedFn();
        localStorage.setItem("Sparicverticalstyles", 'detached');
    });
    /* Hover Submenu End */
    ...
    let iconTextVar = iconTextBtn.addEventListener('click', () => {
        iconTextFn();
        localStorage.setItem("Sparicverticalstyles", 'icontext');
    });
    ...
    let overlayVar = overlayBtn.addEventListener('click', () => {
        iconOverayFn();
        localStorage.setItem("Sparicverticalstyles", 'overlay');
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
                ele.querySelector('ul').style.display = 'none'
    ...
    let doubleVar = doubleBtn.addEventListener('click', () => {
        doubletFn();
        localStorage.setItem("Sparicverticalstyles", 'doublemenu');
    });
    ...
    let menuClickVar = menuClickBtn.addEventListener('click', () => {
        ...
        menuClickFn();
        localStorage.setItem("Sparicnavstyles", 'menu-click');
        localStorage.removeItem("Sparicverticalstyles");
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
    ...
    let menuhoverVar = menuHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        menuhoverFn();
        localStorage.setItem("Sparicnavstyles", 'menu-hover');
        localStorage.removeItem("Sparicverticalstyles");
    ...
    let iconClickVar = iconClickBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconClickFn();
        localStorage.setItem("Sparicnavstyles", 'icon-click');
        localStorage.removeItem("Sparicverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconHoverFn();
        localStorage.setItem("Sparicnavstyles", 'icon-hover');
        localStorage.removeItem("Sparicverticalstyles");
    ...
    let verticalVar = verticalBtn.addEventListener('click', () => {
        ...
        // local storage
        localStorage.removeItem("Spariclayout");
        localStorage.setItem("Sparicverticalstyles", 'default');
        verticalFn();
        setNavActive();
    ...
    let horiVar = horiBtn.addEventListener('click', () => {
        ...
        html.removeAttribute('data-vertical-style');
        //    local storage
        localStorage.setItem("Spariclayout", 'horizontal');
        localStorage.removeItem("Sparicverticalstyles");
...
function lightFn() {
    ...
    localStorage.removeItem("Sparicheaderbg");
    localStorage.removeItem("Sparicbgwhite");
    localStorage.removeItem("Sparicmenubg");
    localStorage.removeItem("Sparicmenubg");
    checkOptions();
...
function horizontalClickFn() {
    ...
    if(!localStorage.SparicMenu && !localStorage.bodylightRGB){
        html.setAttribute("data-menu-styles","light")
        document.querySelector('#switcher-menu-light').checked = true;
        checkOptions();
    }
...
function checkOptions() {
    ...
    // light header
    if (localStorage.getItem('SparicHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('SparicHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('SparicHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('SparicHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('SparicHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('SparicMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('SparicMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('SparicMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('SparicMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('SparicMenu') === 'transparent') {
        document.querySelector('#switcher-menu-transparent').checked = true;
    }

    //boxed
    if (localStorage.getItem('Sparicboxed')) {
        document.querySelector('#switcher-boxed').checked = true;
    }

    //scrollable
    if (localStorage.getItem('Sparicheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('Sparicmenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('Sparicheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('Sparicmenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }

    //classic
    if (localStorage.getItem('Sparicclassic')) {
        document.querySelector('#switcher-classic').checked = true;
    }

    //modern
    if (localStorage.getItem('Sparicmodern')) {
...
function updateColors() {
    ...
    if (document.querySelector("#revenue-analytics") !== null) {
        revenueAnalytics();
    }
