(function () {
    ...
    var options = {
        ...
        colors: ["#467fcf", "#23b7e5", "#f5b849", "#e6533c"],
        responsive: [{
            breakpoint: 480,
            options: {
                legend: {
    ...
    var colors = ['#467fcf', '#23b7e5', '#f5b849', '#49b6f5', '#e6533c', '#26bf94', '#5b67c7'];
    ...
    var options = {
        ...
        colors: ['#467fcf', '#23b7e5', '#f5b849', '#49b6f5', '#e6533c', '#26bf94', '#5b67c7', '#a65e76'],
        plotOptions: {
            bar: {
                columnWidth: '45%',
                distributed: true,
