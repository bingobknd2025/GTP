...
grid: {
  borderColor: 'rgba(119, 119, 142, 0.08)',
    ...
    colors: ['var(--primary-color)', '#5eba00', '#ffca4a', '#ff6666' ,'#867efc', '#3ec7e8', '#2bb4a6', '#00C851'],
    title: {
        text: ''
    },
    xaxis: {
...
colors: ["#5eba00", 'var(--primary-color)', '#3ec7e8', "#ffc107", "#5c509b"],
};
...
// $('.second-sidemenu .home-sparic').addClass('resp-tab-content-active');
   ...
   function index1() {
    ...
    document.querySelector("#totalInvestmentsStats").innerHTML= " ";
    var chart = new ApexCharts(document.querySelector("#totalInvestmentsStats"), options);
    chart.render();
  }